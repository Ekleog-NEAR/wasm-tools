...
impl ComponentState {
    ...
    pub fn add_core_type(
        ...
        current.core_types.push(TypeId::new(ty.type_size(), types.len(), Some(current.core_types.len()), true));
        types.push(ty);
    ...
    pub fn add_core_module(
        ...
        self.core_modules.push(TypeId::new(ty.type_size(), types.len(), None, true));
    ...
    pub fn add_type(
        ...
        current.types.push(TypeId::new(ty.type_size(), types.len(), Some(current.types.len()), false));
        types.push(ty);
    ...
    pub fn lower_function(
        ...
        self.core_funcs.push(TypeId::new(lowered_ty.type_size(), types.len(), None, true));
    ...
    pub fn add_component(&mut self, component: &mut Self, types: &mut TypeList) {
        ...
        self.components.push(TypeId::new(ty.type_size(), types.len(), None, false));
